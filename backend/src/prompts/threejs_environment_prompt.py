...
- For non-seat furniture (sofa/bed/table/storageUnit): yaw_deg = 0 faces +Z (toward camera/front wall), 90 faces +X (right wall), 180 faces -Z (back wall), 270 faces -X (left wall). Use this when setting yaw. Include length_m for table objects when known (0.6–2.4m).
